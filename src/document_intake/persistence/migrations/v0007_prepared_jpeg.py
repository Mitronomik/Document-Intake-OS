...
STATEMENTS: tuple[str, ...] = (
    ...
    "ALTER TABLE stored_artifacts RENAME TO stored_artifacts_v0006",
    ...
    "INSERT INTO stored_artifacts SELECT * FROM stored_artifacts_v0006",
    "DROP TABLE stored_artifacts_v0006",
